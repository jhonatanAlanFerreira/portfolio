...
export default function TechCarousel() {
  ...
  return (
    ...
    >
      <p className="absolute pt-2 pl-1 text-[5px] font-semibold tracking-widest text-gray-400 group-hover:hidden after:mt-1 after:block after:h-px after:w-8 after:bg-slate-600/40 2xl:text-[11px]">
        Tech
      </p>
      <div
        ref={firstItemRef}
