...
export default function ResumeDownload() {
  ...
  return (
    ...
    >
      <button className="group relative mt-2 cursor-pointer overflow-hidden rounded-md border border-dotted border-slate-900/80 px-1 py-0.5 text-[5px] text-white/70 lg:px-3 lg:py-1 lg:text-[10px] 2xl:text-sm">
